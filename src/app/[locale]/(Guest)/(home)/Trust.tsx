...
export default async function Trust() {
  ...
  const STATS = [
    { value: formatNumber(stats.total_products), label: t("stat1_label"), sub: t("stat1_sub"), icon: "📊", color: "text-primary-main", bg: "bg-primary-main/8 border-primary-main/15" },
    { value: formatNumber(stats.total_shops), label: t("stat2_label"), sub: t("stat2_sub"), icon: "🛡️", color: "text-success-main", bg: "bg-success-main/8 border-success-main/15" },
    { value: t("stat3_value"), label: t("stat3_label"), sub: t("stat3_sub"), icon: "📉", color: "text-secondary-main", bg: "bg-secondary-main/8 border-secondary-main/15" },
    { value: t("stat4_value"), label: t("stat4_label"), sub: t("stat4_sub"), icon: "⚖️", color: "text-warning-main", bg: "bg-warning-main/8 border-warning-main/15" },
  ];
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {STATS.map((s, i) => (
          ...
          >
            ...
            <div>
              <div className={`text-3xl font-black tracking-tighter ${s.color}`}>
                {s.value}
              </div>
